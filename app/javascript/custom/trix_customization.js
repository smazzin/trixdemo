...
function toolbarDefaultHTML() {
  ...
  <div class="trix-button-row">
     ...
     <span class="trix-button-group trix-button-group--block-tools" data-trix-button-group="block-tools">
       ...
       <button type="button" class="trix-button trix-button--icon trix-button--icon-heading" data-trix-attribute="heading" title="${lang.heading}" tabindex="-1">${lang.heading}</button>
       <button type="button" class="trix-button trix-button--icon trix-button--icon-heading" data-trix-attribute="subHeading" title="${lang.subHeading}" tabindex="-1">${lang.subHeading}</button>
